...
public sealed class MorphSet : ArrayWrapper<string>, IEquatable<MorphSet>
{
    ...
    public static MorphSet Create(IEnumerable<string> morphs) => morphs is null ? Empty : TakeArray(morphs.ToArray());

    internal static MorphSet TakeArray(string[] morphs) => morphs is null ? Empty : new MorphSet(morphs);
    ...
    private MorphSet(string[] morphs) : base(morphs)
    {
    }
